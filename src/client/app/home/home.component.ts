...
export class HomeComponent implements OnInit {
  ...
  private showCriteria: boolean;
  private fieldVals: Array<String>;
  private operatorVals: Array<String>;
  private operatorVals2: Array<String>;
  private operatorVals3: Array<String>;
  private strOperatorVals: Array<String>;
  private numOperatorVals: Array<String>;
  private criterias: any[];
  private query_string: String;
  private operator3: any;
